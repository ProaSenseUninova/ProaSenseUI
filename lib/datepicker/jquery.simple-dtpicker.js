 ...
 (function($) {
	...
	**/
	...
	var init = function($obj, opt) {
		...
		}, opt.date===undefined?opt.current:opt.date);
	};
	 ...
	 */
	 $.fn.dtpicker = function(config) {
		var date =config.date===undefined?new Date():config.date;
	 ...
	 * */
	 $.fn.appendDtpicker = function(config,inDate) {
		var date =inDate===undefined? new Date():inDate;
		var defaults = getDefaults();
		config.date=date;
		...
		return this.each(function(i) {
			...
			var $picker_parent = $($d).dtpicker(options,date); // call dtpicker() method
