 ...
 */
	...
	$.jstree.core.prototype = {
		...
		init : function (el, options) {
			...
			this.element.css('color',this.settings.core.color==undefined?'black':this.settings.core.color);
			this.element.css('font-weight',this.settings.core.bold==true?'bold':'normal');
			if(this.settings.core.width!=undefined)
			{
				this.element.css('width',this.settings.core.width)
			}
			if(this.settings.core.noBorder==true)
			{
