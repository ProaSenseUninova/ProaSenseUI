...
(function($) {
	...
	$.elycharts.line = {
		...
		draw: function(env) {
			...
			var length = values[Object.keys(values)[0]].length;
			
			for(var ik = 0; ik<limits.length;ik++)
			{
				values['limit'+ik]=Array.apply(null,Array(length)).map(function(){return limits[ik]});
			}
			...
			//   labels.push(null);
			labelsCount = env.plots.serie1.from.length; //labels.length;
