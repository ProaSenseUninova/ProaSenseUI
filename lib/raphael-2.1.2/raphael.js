...
! function(a, b) {
			...
			for (p = 0; q > p; p++)
				if (e = i[p], "zIndex" in e)
					if (e.zIndex == l[k]) {
						...
						do
							if (k++, e = m[l[k]], e && n.push(e.apply(d, g)), b) break;
						while (e)
					} else m[e.zIndex] = e;
	...
	return j._events = i, j.listeners = function(a) {
		var b, c, d, g, h, j, k, l, m = a.split(e),
			n = i,
			o = [n],
			p = [];
		...
		for (var c = a.split(e), d = i, f = 0, h = c.length; h > f; f++) d = d.n, d = d.hasOwnProperty(c[f]) && d[c[f]] || (d[c[f]] = {
			n: {}
		});
		...
		if (!a) return void(j._events = i = {
			n: {}
		});
		var c, g, h, k, l, m, n, o = a.split(e),
			p = [i];
